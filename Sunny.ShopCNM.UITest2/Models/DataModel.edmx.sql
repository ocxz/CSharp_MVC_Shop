...
-- --------------------------------------------------
-- Date Created: 08/19/2019 13:33:53
-- Generated from EDMX file: F:\c#代码\c#进阶学习\5、Asp.Net学习\8、Mvc实现超市后台cnm\Sunny.ShopCNM\Sunny.ShopCNM.UITest2\Models\DataModel.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [Sunny.ShopCNMTest2];
GO
...
-- Creating foreign key on [ProvinceId] in table 'Address'
ALTER TABLE [dbo].[Address]
...
-- Creating foreign key on [CityId] in table 'Address'
ALTER TABLE [dbo].[Address]
...
-- Creating foreign key on [CountyId] in table 'Address'
ALTER TABLE [dbo].[Address]
ADD CONSTRAINT [FK_CountyAddress]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_CountyAddress'
CREATE INDEX [IX_FK_CountyAddress]
ON [dbo].[Address]
    ([CountyId]);
GO
