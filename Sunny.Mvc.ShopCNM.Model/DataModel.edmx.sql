...
-- --------------------------------------------------
-- Date Created: 08/23/2019 15:28:21
-- Generated from EDMX file: F:\c#代码\c#进阶学习\5、Asp.Net学习\8、Mvc实现超市后台cnm\Sunny.ShopCNM\Sunny.Mvc.ShopCNM.Model\DataModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_ProviderAddress]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Provider] DROP CONSTRAINT [FK_ProviderAddress];
GO
